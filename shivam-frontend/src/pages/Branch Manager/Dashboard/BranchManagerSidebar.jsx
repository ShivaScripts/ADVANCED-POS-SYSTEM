// src/pages/Branch Manager/components/BranchManagerSidebar.jsx
// (I'm assuming this file's path based on our previous talk)
...
import {
  ...
  FileText,
  LogOut,
  Zap // --- START: ADD THIS IMPORT ---
} from "lucide-react";
import { Button } from "@/components/ui/button";
import { RefreshCw } from "lucide-react";

const navLinks = [
  // --- START: ADD THIS NEW LINK ---
  {
    name: "Live Dashboard",
    path: "/branch/live-dashboard",
    icon: <Zap className="w-5 h-5 text-yellow-500" />, // Added a color
  },
  // --- END: ADD THIS NEW LINK ---
  {
    name: "Dashboard",
                ...
                <span
                  className={`transition-colors ${
                    location.pathname.startsWith(link.path)
                      ...
                      // --- Simplified icon color logic a bit ---
