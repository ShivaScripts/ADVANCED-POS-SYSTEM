// pos-frontend-vite/src/pages/cashier/customer/components/PurchaseHistory.jsx
                    ...
                    <div className="space-y-1">
                      {order.items.map((item, index) => (
                        <div key={index} className="flex justify-between text-sm">
                          {/* --- START: THE FIX --- */}
                          {/* Check for item.product *before* accessing .name */}
                          <span>{item.product ? item.product.name : item.productName || 'Unknown Product'}</span>
                          {/* --- END: THE FIX --- */}
