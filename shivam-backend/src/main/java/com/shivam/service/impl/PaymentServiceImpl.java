...
import com.shivam.modal.SubscriptionPlan;
...
import com.shivam.repository.SubscriptionPlanRepository;
...
import java.util.HexFormat; // IMPORT THIS INSTEAD OF DatatypeConverter
...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Map<String, String> createPosOrder(Double amount) throws RazorpayException {
        try {
    ...
    public boolean verifyPaymentSignature(Map<String, String> payload) {
        try {
            ...
            String expectedSignature = generateHmacSha256Signature(
    ...
    // Helper method for generating the signature
    ...
    // --- YOUR EXISTING SUBSCRIPTION METHODS (NO CHANGES) ---
