...
import com.shivam.payload.StoreAnalysis.CategorySalesDTO;
...
// store analysis
    ...
    @Query("""
        SELECT new com.shivam.payload.StoreAnalysis.CategorySalesDTO(
            p.category.name,
    ...
    @Query("""
        SELECT new com.shivam.payload.dto.ProductDTO(
                p.id,
                p.name,
                p.sku,
                p.description,
