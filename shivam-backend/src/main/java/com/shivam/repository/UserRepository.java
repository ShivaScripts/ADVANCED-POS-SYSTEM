...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	List<User> findByStoreAndRoleIn(com.shivam.modal.Store store, List<UserRole> roles);
	List<User> findByBranchAndRoleIn(com.shivam.modal.Branch branch, List<UserRole> roles);
...
int countByStoreAdminIdAndRoles(@Param("storeAdminId") Long storeAdminId,
	...
	@Query("""
    SELECT new com.shivam.payload.dto.UserDTO(
		u.id,
		u.email,
    ...
    AND u.role = com.shivam.domain.UserRole.ROLE_BRANCH_CASHIER
""")
